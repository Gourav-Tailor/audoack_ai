...
from .billing_payments import CreateRazorpayOrderView, VerifyRazorpayPaymentView, razorpay_webhook
...
urlpatterns = [
    ...
    path("billing/pay/", CreateRazorpayOrderView.as_view(), name="billing_create_order"),
    path("billing/payment/verify/", VerifyRazorpayPaymentView.as_view(), name="billing_verify_payment"),
    ...
    path("api/v1/sessions/<int:batch_id>/chunks/", SessionChunkView.as_view(), name="api_v1_session_chunk"),
    path("api/v1/sessions/<int:batch_id>/finalize/", SessionFinalizeView.as_view(), name="api_v1_session_finalize"),
    path("api/v1/sessions/<int:batch_id>/heartbeat/", SessionHeartbeatView.as_view(), name="api_v1_session_heartbeat"),
    path("api/v1/latest-analysis/", LatestDeviceAnalysisView.as_view(), name="api_v1_latest_analysis"),
    path("api/v1/demo/start/", PublicDemoStartView.as_view(), name="api_v1_demo_start"),
    path("api/v1/demo/<int:batch_id>/chunk/", PublicDemoChunkView.as_view(), name="api_v1_demo_chunk"),
    ...
    path("api/v1/mobile/devices/<int:device_id>/transcripts/", MobileDeviceTranscriptsView.as_view(), name="mobile_device_transcripts"),
]
